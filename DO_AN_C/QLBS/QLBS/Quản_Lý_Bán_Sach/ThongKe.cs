...
namespace Quản_Lý_Bán_Sach
{
    public partial class ThongKe : Form
    {
        ...
        public void loadData()
        {
            ...
            dtgThongKeSach.RowsDefaultCellStyle.BackColor = Color.LemonChiffon;
            dtgThongKeSach.AlternatingRowsDefaultCellStyle.BackColor = Color.White;

            dgvTKSNLau.RowsDefaultCellStyle.BackColor = Color.LemonChiffon;
            dgvTKSNLau.AlternatingRowsDefaultCellStyle.BackColor = Color.White;

            dgvTKSLCIt.RowsDefaultCellStyle.BackColor = Color.LemonChiffon;
        ...
        private void btnTK_Click(object sender, EventArgs e)
        {
            ...
            dgvTKSNLau.Rows[0].DefaultCellStyle.BackColor = Color.LemonChiffon;
        }
