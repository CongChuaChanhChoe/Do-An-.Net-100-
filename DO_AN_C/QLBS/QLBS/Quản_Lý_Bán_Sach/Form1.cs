...
namespace Quản_Lý_Bán_Sach
{
    public partial class frmQLBS : Form
    {
        ...
        public void loadData()
        {
            ...
            //sắp xếp
            dgvSach.Sort(dgvSach.Columns["MaSach"], System.ComponentModel.ListSortDirection.Descending);

            dgvSach.RowsDefaultCellStyle.BackColor = Color.LemonChiffon;
            dgvSach.AlternatingRowsDefaultCellStyle.BackColor = Color.White;

            dgvTimSach.RowsDefaultCellStyle.BackColor = Color.LemonChiffon;
            dgvTimSach.AlternatingRowsDefaultCellStyle.BackColor = Color.White;
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            {
                if (dgvSach[1, i].Value.ToString() == cmbTKSach.Text)
                {
            ...
            cmbTKSach.DisplayMember = dataTable.Columns["TenSach"].ToString();
            cmbTKSach.ResetText();
        }
